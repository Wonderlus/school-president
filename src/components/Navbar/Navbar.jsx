    ...
    return ( 
        <header className={styles.container}>
            <div className={styles.navbar}>
                <Image onClick={() => {router.push("/")}} src={"/logo.jpg"} alt="School2098" className={styles.logo} width={50} height={50}/>
                ...
                {status === "unauthenticated" || status === "loading" ? (
                    <div className={styles.authLinks}>
                        ...
                        <Link className={styles.link} href={"/registration"}>Зарегистрироваться</Link>
                    </div>
                ...
                <div className={styles.burgerLinksAll}>
